...
<%!static int count; %>
   <%
   Dummy.Mongo = new MongoClient("localhost", 27234);
...
<div class="container">
  ...
  <div class="container-fluid" style="background: rgba(0, 228, 255, 0.52)"  >
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active" style="background-color: rgba(0, 228, 255, 0.52);"; ><a href="#">METADATA <span class="sr-only">(current)</span></a></li>
 ...
 <!--            		<div class="col-md-6 col-sm-6 col-xs-6 text-right"><a href="" class="rIcon allRead" data-tooltip="tooltip" data-placement="bottom" title="tümü okundu."><i class="fa fa-dot-circle-o"></i></a></div> -->
            ...
            <%
            FindIterable<Document> drop = Dummy.notifyColl.find();
            ...
            %>
            	...
            	<div class="col-md-3 col-sm-3 col-xs-3"><div class="notify-img"><!-- <img src="http://placehold.it/45x45" alt=""> --></div></div> 
            		...
            		<a  id="npid" href=""><% out.println(doc1.get("NPI")); %></a><%out.println(doc1.get("Date_&_Time"));%><br>
            		<a  id="present" href=""><% out.println("updated Area" + " " +present); %></a><br>
            		<hr>
            		<p class="time"></p>
            		</div>
            	</li>
