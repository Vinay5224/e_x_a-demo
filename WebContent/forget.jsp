...
<div class="container">
  <h2 style="margin-left:350px;"><b> FORGOT PASSWORD </b> </h2> <a href="login.jsp" class="btn btn-primary btn-lg" style="margin-left:20px; margin-top:-50px;"><span class="glyphicon glyphicon-home"></span></a><img src="img/logo.png" alt="" style="margin-top: -70px; margin-left:980px;">
