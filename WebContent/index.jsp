...
<div class="column col-lg-2 col-md-2 col-sm-2" style="height:80px; margin-left:250px; ">
...
<div class="column col-lg-2 col-md-2 col-sm-2" style="height:80px; background-image:url(); background-repeat:no-repeat;">
