...
<%!static int count; %>
   <%
	...
	MongoClient client = new MongoClient(new ServerAddress("localhost", 27234), Arrays.asList(credential));

	Dummy.DB = client.getDatabase("Provider");
...
<h6><font color="white" style="font-weight: 700;font-size: 10px;margin-left: -10px;cursor: pointer; color:white" ><a style="color: white;" href="npialerts.jsp">NPI ALERT</a></font></h6>
 ...
 <!--            		<div class="col-md-6 col-sm-6 col-xs-6 text-right"><a href="" class="rIcon allRead" data-tooltip="tooltip" data-placement="bottom" title="tÃƒÂ¼mÃƒÂ¼ okundu."><i class="fa fa-dot-circle-o"></i></a></div> -->
            ...
            <%
            Dummy.credential =MongoCredential.createCredential("Exafluencep", "Provider", "$Exafluence@123".toCharArray());

            Dummy.Mongo = new MongoClient(new ServerAddress("34.234.131.180", 27234), Arrays.asList(credential));

            Dummy.DB  = Dummy.Mongo.getDatabase("ARUJ");
            Dummy.notifyColl =  Dummy.DB .getCollection("MEMBER");
...
<div class="column col-lg-5 col-md-5 col-sm-5" style="height:80px; ">
