...
<body style=" background-color: floralwhite; ">
	...
	<nav style="background-color:#d1e3f5!important" class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
		...
		<a href="index.jsp"><img alt=""  width="100px" src="img/logo.png"></a>
	</nav>
