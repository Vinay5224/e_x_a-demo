...
<body >
 <div class="container">
  <h2><b>RESET PASSWORD</b> </h2> <a href="login.jsp" class="btn btn-primary btn-lg" style="margin-left:1100px; margin-top:-50px;"><span class="glyphicon glyphicon-home"></span></a>
    <div class="div2">
   <form action="">
