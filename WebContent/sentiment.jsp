...
function get_topic()
{
	...
	$.get("http://52.21.13.124:5122/tw_senti",{topic:topic},tw_result)
	/* $.get("http://54.88.141.161:5122/tw_senti",{topic:topic},tw_result) */
...
<nav id="top-bar" class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top" data-spy="affix" >
 <!-- <a class="navbar-brand" href="#">
   ...
   <ul class="nav navbar-nav ml-auto">
    <li class="nav-item">
      <a class="nav-link" href="index.jsp">About ExaHealth</a>
    </li>
