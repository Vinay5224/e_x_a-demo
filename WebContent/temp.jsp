...
<body>
 ...
 <div class="hidden-xs col-sm-1 nav-activity" style="margin-top:80px;">
       ...
       <p style="width:40px; height:40px; background-image:url(img/payer.png); background-repeat:no-repeat; margin-top:10%;"></p>
        ...
        </g></svg></span><span class="activity-title" style="font-size:11px; margin-top:10%;">Device Manufactuers</span></a><a class=
        ...
        "activity-title" style="font-size:11px; margin-top:10%;">Providers</span></a><a class=
        ...
        "0 0 46.9 46.9" xmlns="http://www.w3.org/2000/svg">
         <p style="width:40px; height:40px; background-image:url(img/metadata.png); background-repeat:no-repeat; margin-top:10%;"></p>
     </svg></span><span class=
        "activity-title" style="font-size:11px; margin-top:10%;">Metadata Glossary</span></a>
        ...
        <p style="width:40px; height:40px; background-image:url(img/reg.png); background-repeat:no-repeat; margin-top:10%;"></p>
        
        
        
        
        
        </svg></span><span class="activity-title" style="font-size:12px; margin-top:10%;">Registries
       </span><!--<span class="activity-listings">Motocross, touring,
...
<div class="col-md-12" style="height:auto; background-color:#0a3873;">
<div class="row">

<div class="col-md-2" style="height:80px; ">
<center><p style="width:40px; height:40px;background-image:url(img/bell.png); background-repeat:no-repeat; margin-top:16px;"></p></center>
...
<center><p style="width:40px; height:40px;background-image:url(img/twittericon.png); background-repeat:no-repeat; margin-top:16px;"></p></center>
...
<!--<div class="col-md-3" style="height:80px; background-color:rgb(0,255,255);"></div>-->
...
<div class="container">
  ...
  <!--       <tspan x="28" y="0"></tspan>
      ...
      <text class="cls-1" transform="translate(105 966)">
        ...
        <tspan x="28" y="0">Social</tspan>
        <tspan x="-38" y="28">Media Sentiment</tspan>
      </text>
  ...
  <path d="M479.663 444.632c0-19.317-15.716-35.032-35.032-35.032-19.316 0-35.032 15.715-35.032 35.032 0 19.317 15.716 35.032 35.032 35.032 19.316-.001 35.032-15.716 35.032-35.032zm-53.895 0c0-10.401 8.463-18.863 18.863-18.863 10.401 0 18.863 8.463 18.863 18.863 0 10.401-8.463 18.863-18.863 18.863s-18.863-8.463-18.863-18.863zM32.337 444.632c0 19.317 15.716 35.032 35.032 35.032 19.316 0 35.032-15.715 35.032-35.032 0-19.317-15.716-35.032-35.032-35.032-19.316 0-35.032 15.715-35.032 35.032zm53.895 0c0 10.401-8.463 18.863-18.863 18.863-10.401 0-18.863-8.463-18.863-18.863 0-10.401 8.463-18.863 18.863-18.863 10.4-.001 18.863 8.462 18.863 18.863zM264.084 445.709v-2.156c0-4.466-3.62-8.084-8.084-8.084-4.465 0-8.084 3.618-8.084 8.084v2.156c0 4.466 3.62 8.084 8.084 8.084 4.465.001 8.084-3.618 8.084-8.084z"/>
    ...
    <text x="290" y="270" style="fill:red;" class="learn-more-text">Learn more</text>
  </svg>
</div>
...
var services_data = [{ name: "Claims", icon: "industries" }, { name: "Meta\ Data", icon: "validation" }, { name: "Segmentation", icon: "engineering" }, { name: "Social Media\ Sentiment", icon: "management" }, { name: "Population\ Health", icon: "manufacturing" }, { name: "\Member", icon: "technical" }, { name: "\Provider", icon: "process" }];
