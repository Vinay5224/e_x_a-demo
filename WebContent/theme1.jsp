...
MongoClient client = new MongoClient("192.168.0.230",27081);
...
%>
   ...
   <hr  style="border-color:#42ff33">
    ...
    border-width:  3px; color:white "> <span id="close" style="cursor: pointer;  aria-hidden="true">&times;</span>        
     ...
     <iframe id="meta1" src="https://app.powerbi.com/view?r=eyJrIjoiNTkyOGQ0ZjktNWRiYy00ZjI4LWFmMjUtMzg4ZDA1NzZmNWEyIiwidCI6ImQ2ZWVkNDY1LWUzZmYtNDM4Yi05OTUwLTQ2OGI1ZjlhZTE3MSJ9" height="600" width="1000"></iframe>
    </div>
  </div>
